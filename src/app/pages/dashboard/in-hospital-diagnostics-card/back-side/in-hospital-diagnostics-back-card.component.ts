...
@Component({
  selector: 'ngx-in-hospital-diagnostics-back-card',
  styleUrls: ['./in-hospital-diagnostics-back-card.component.scss'],
  templateUrl: './in-hospital-diagnostics-back-card.component.html',
})
export class InHospitalDiagnosticsBackCardComponent implements OnInit, AfterViewInit, OnDestroy {
