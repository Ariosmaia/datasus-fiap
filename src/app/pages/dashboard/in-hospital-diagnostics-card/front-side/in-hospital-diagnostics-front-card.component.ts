...
@Component({
  selector: 'ngx-in-hospital-diagnostics-front-card',
  styleUrls: ['./in-hospital-diagnostics-front-card.component.scss'],
  templateUrl: './in-hospital-diagnostics-front-card.component.html',
})
export class InHospitalDiagnosticsFrontCardComponent implements OnDestroy {
